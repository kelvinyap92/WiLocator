...
/**
 * This class is a setup fingerprint class where adding,deleting, calibrating and recalibrating fingerprint are done 
 * when connected to the server. Admin can locate themself manually by clicking the locate button
 * 
 * @author kelvinyap
 *
 */
public class SetupFingerprint extends Activity implements OnClickListener,
		OnTouchListener {

	//Button and Edidtext variables
	...
	private static final String TAG = "setupFingerprint";
	...
	/** 
	 * Handles the functionality adding,removing,calibrate,recalibrating, and locating.
	 */
	@Override
	public void onCreate(Bundle savedInstanceState) {
		...
		/**
		 * Scan wifi results and send instructions to the server to add fingerprint
		 */
		...
		}); // end add / sending fingerprint

		
		
		/**
		 * Send instructions to the server to remove fingerprint
		 */
		...
		/**
		 * Scan wifi results and send instructions to the server to calibrate fingerprint
		 */
		...
		/**
		 * Scan wifi results and send instructions to the server to recalibrate fingerprint
		 */
		...
		/**
		 * Scan wifi results and send instructions to the server to manually locate the admin client
		 */
	...
	/**
	 * get user input from textEdit for fingerprint name
	 */
	...
	/**
	 *  Get the coordinate of x,y when press on the canvas map
	 */
